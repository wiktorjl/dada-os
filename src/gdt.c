...
void gdt_init() {
    ...
    gdt_build_segment_descriptor(GDT_SEGMENT_SUPER_CODE, GDT_BASE_SEGMENT_ADDRESS, GDT_SEGMENT_SIZE, GDT_ATTR_CODE_SUPER_MODE, GDT_ATTR_DEFAULT_GRANULARITY);

    // Data super-user segment
    gdt_build_segment_descriptor(GDT_SEGMENT_SUPER_DATA, GDT_BASE_SEGMENT_ADDRESS, GDT_SEGMENT_SIZE, GDT_ATTR_DATA_SUPER_MODE, GDT_ATTR_DEFAULT_GRANULARITY);

    // Code user segment
    gdt_build_segment_descriptor(GDT_SEGMENT_USER_CODE, GDT_BASE_SEGMENT_ADDRESS, GDT_SEGMENT_SIZE, GDT_ATTR_CODE_USER_MODE, GDT_ATTR_DEFAULT_GRANULARITY);

    // Data user segment
    gdt_build_segment_descriptor(GDT_SEGMENT_USER_DATA, GDT_BASE_SEGMENT_ADDRESS, GDT_SEGMENT_SIZE, GDT_ATTR_DATA_USER_MODE, GDT_ATTR_DEFAULT_GRANULARITY);
